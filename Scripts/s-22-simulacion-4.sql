...
-- @Fecha					12/01/2022
-- @Descripcion		script 4: simulación carga de datos y backup

Prompt fecha 2022/Enero/16  05:01 hrs
!sudo date --set "2022-01-16 05:01"
...
Prompt fecha 2022/Enero/17  04:59 hrs
!sudo date --set "2022-01-17 04:56"
