...
-- @Fecha					12/01/2021
-- @Descripcion		scriipt 5: simulación carga de datos y backup

Prompt fecha 2021/Enero/17  05:01 hrs
!sudo date --set "2021-01-17 05:01"
...
Prompt fecha 2021/Enero/18  04:59 hrs
!sudo date --set "2021-01-18 04:56"
