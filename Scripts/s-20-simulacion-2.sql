...
-- @Fecha					12/01/2021
-- @Descripcion		scriipt 2: simulación carga de datos y backup

Prompt fecha 2021/Enero/14  05:01 hrs
!sudo date --set "2021-01-14 05:01"
...
Prompt fecha 2021/Enero/15  04:59 hrs
!sudo date --set "2021-01-15 04:56"
