...
-- @Fecha					12/01/2022
-- @Descripcion		script 2: simulación carga de datos y backup

Prompt fecha 2022/Enero/14  05:01 hrs
!sudo date --set "2022-01-14 05:01"
...
Prompt fecha 2022/Enero/15  04:59 hrs
!sudo date --set "2022-01-15 04:56"
