...
-- @Fecha					12/01/2021
-- @Descripcion		scriipt 1: simulación carga de datos y backup

Prompt fecha 2021/Enero/13  05:01 hrs
!sudo date --set "2021-01-13 05:01"
...
Prompt fecha 2021/Enero/14  04:59 hrs
!sudo date --set "2021-01-14 04:56"
