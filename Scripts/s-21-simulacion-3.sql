...
-- @Fecha					12/01/2021
-- @Descripcion		scriipt 3: simulación carga de datos y backup

Prompt fecha 2021/Enero/15  05:01 hrs
!sudo date --set "2021-01-15 05:01"
...
Prompt fecha 2021/Enero/16  04:59 hrs
!sudo date --set "2021-01-16 04:56"
