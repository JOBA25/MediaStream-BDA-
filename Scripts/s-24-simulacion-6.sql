...
-- @Fecha					12/01/2022
-- @Descripcion		script 6: simulación carga de datos y backup

Prompt fecha 2022/Enero/18  05:01 hrs
!sudo date --set "2022-01-18 05:01"
...
Prompt fecha 2022/Enero/19  04:59 hrs
!sudo date --set "2022-01-19 04:56"
