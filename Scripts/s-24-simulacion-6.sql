...
-- @Fecha					12/01/2021
-- @Descripcion		scriipt 6: simulación carga de datos y backup

Prompt fecha 2021/Enero/18  05:01 hrs
!sudo date --set "2021-01-18 05:01"
...
Prompt fecha 2021/Enero/19  04:59 hrs
!sudo date --set "2021-01-19 04:56"
